...
def main():
    ...
    if "user_info" not in st.session_state:
        ...
        if auth_code:
            ...
            if access_token:
                ...
                if email in approved_emails:
                    ...
                    log_event("UserLogin", email=email, details="User logged in successfully")
                ...
                log_event("UserLoginFailed", details="Failed to retrieve access token")
                st.stop()
        else:
        ...
        if st.button("Logout"):
            ...
            log_event("UserLogout", email=email, details="User logged out")
